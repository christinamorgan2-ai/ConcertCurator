...
import { LayoutDashboard, ListMusic, MapPin, Mic2, Users, Tags, Settings, LogOut, LogIn, Globe, Menu, Info, Network, HelpCircle } from 'lucide-react';
      ...
      <nav className={`sidebar-nav ${mobileOpen ? 'open' : ''}`}>
        <div style={styles.topSection}>
          ...
          <div style={styles.navGroup}>
            ...
            {navItem("/faq", HelpCircle, "FAQ", false)}
            {navItem("/contact", Info, "Contact", false)}
          </div>
        </div>
